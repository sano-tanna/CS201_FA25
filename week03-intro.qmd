...
author: "Amber Camp (Edited by Sano Tanna)"
date: "2025-09-08"
format: html
editor: visual
---
...
ggplot(mtcars, aes(x = wt, y = hp)) +
  geom_point() +
  labs(
    title = "Heavier cars tend to have higher horsepower",
    x = "Weight (1000 lbs)",
    y = "Horsepower"
  )

ggplot(mtcars, aes(x = hp)) +
  geom_histogram(binwidth = 20, fill = "yellow", color = "black") +
  labs(
...
ggplot(mtcars, aes(x = cut_number(wt, 4), y = hp)) +
  geom_boxplot(fill = "red", color = "black") +
  labs(
    title = "Horsepower by Weight Quartile",
    x = "Weight Quartile (1000 lbs)",
    y = "Horsepower"
  )
