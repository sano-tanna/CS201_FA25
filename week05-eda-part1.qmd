...
Answer: Histograms are used for continuous data and bar charts can be used with categorical data.
...
-   How do you read a boxplot, and what are the different landmarks? To read a boxplot, you can

## Extra Credit!

-   Share with the class how to read a boxplot (1pt each!)

    -   The box = the middle 50% of teh data (between Q1 and Q3)

    -   The line inside the box = the median (middle value)

    -   The whiskers = strech out to the smallest and largest "normal" values

    -   Dots beyond the whiskers are the outliers (unusual values)

-   Find the difference(s) between \|\> and %\>% and email me (1pt).

-   `|>` doesnt need a package while %\>% needs a package installed (dplyr/tidyverse)
